const { Text, StyleSheet, View, Image, Pressable } = require("react-native")
import { useEffect } from 'react';
import OptionImage from '../../../assets/option.png';

const PostDetailCommentItem = ({ commentModal, setCommentModal }) => {
  useEffect(() => { console.log(commentModal) }, [commentModal]);
      ...
      <View style={styles.PostDetailCommentItemContentContainer}>
        ...
        <View style={{ marginRight: 'auto', }}>
          ...
          {commentModal && <View style={styles.PostDetailCommentModal}>
            <View style={{ alignItems: 'center', justifyContent: 'center', borderColor: 'white', borderBottomColor: '#D9D9D9', borderWidth: 3, height: 25 }}>
              <Text>신고</Text>
            </View>
